...
function Hero() {
     return (
          <motion.div className="px-4 md:px-8 min-h-[700px] mb-16 flex flex-col items-center md:pt-20  md:max-w-2xl lg:max-w-6xl mx-auto" initial={{ translateY: -800 }} animate={{ translateY: 0 }} exit={{ opacity: 0 }}>
