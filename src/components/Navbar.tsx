...
function NavBar() {
     ...
     return (
          <motion.div className='flex h-16 items-center p-4 md:px-8 md:max-w-2xl lg:max-w-6xl mx-auto justify-between  sticky top-0 bg-[#282C34] z-10' initial={{ translateY: -500 }} animate={{ translateY: 0 }} exit={{ opacity: 0 }}>
